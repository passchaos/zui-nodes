...
pub const node_editor_commands = [_]Command{
    ...
    .{ .id = NodeEditorCommand.select_upstream_nodes.commandId(), .title = "Select Upstream Nodes", .description = "Select the complete upstream dependency chain feeding the active selection or link", .category = node_editor_command_category, .panel_role = .viewport },
    .{ .id = NodeEditorCommand.select_downstream_nodes.commandId(), .title = "Select Downstream Nodes", .description = "Select the complete downstream dependency chain reached from the active selection or link", .category = node_editor_command_category, .panel_role = .viewport },
