...
pub const commitNodeEditorConnectionSpawn = command_dispatch.commitConnectionSpawn;
...
pub const ConnectionSpawnRequest = node_editor.ConnectionSpawnRequest;
pub const ConnectionSpawnPlan = node_editor.ConnectionSpawnPlan;
pub const ConnectionSpawnCommitResult = node_editor.ConnectionSpawnCommitResult;
pub const ConnectionSpawnOptions = node_editor.ConnectionSpawnOptions;
...
pub const compatibleTemplatePort = node_editor.compatibleTemplatePort;
pub const commitConnectionSpawnWithHistory = node_editor.commitConnectionSpawnWithHistory;
