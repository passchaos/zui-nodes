...
pub const selectionStateFromCore = node_editor_adapters.selectionStateFromCore;
pub const coreSelectionStateFrom = node_editor_adapters.coreSelectionStateFrom;
pub const clipboardFromCore = node_editor_adapters.clipboardFromCore;
pub const coreClipboardFrom = node_editor_adapters.coreClipboardFrom;
pub const corePortTypeFrom = node_editor_adapters.corePortTypeFrom;
pub const corePortTypesFrom = node_editor_adapters.corePortTypesFrom;
pub const coreNodeFrom = node_editor_adapters.coreNodeFrom;
pub const coreConnectionFrom = node_editor_adapters.coreConnectionFrom;
pub const copyCoreGroupsFrom = node_editor_adapters.copyCoreGroupsFrom;
pub const coreGroupFrom = node_editor_adapters.coreGroupFrom;
pub const coreTemplateFrom = node_editor_adapters.coreTemplateFrom;
pub const coreChainTemplateFrom = node_editor_adapters.coreChainTemplateFrom;
pub const copyCoreNodesFrom = node_editor_adapters.copyCoreNodesFrom;
pub const copyCoreConnectionsFrom = node_editor_adapters.copyCoreConnectionsFrom;
pub const copyCoreTemplatesFrom = node_editor_adapters.copyCoreTemplatesFrom;
